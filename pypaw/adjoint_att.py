...
from pytomo3d.adjoint import \
    calculate_and_process_attenuation_adjsrc_on_stream
...
def adjoint_wrapper(obsd_station_group, synt_station_group, config=None,
    ...
    adjsrcs = calculate_and_process_attenuation_adjsrc_on_stream(
        observed, synthetic, window_sta, obsd_staxml, config, event,
        adj_src_type, reference_frequency, postproc_param,
...
class AttenuationAdjointASDF(ProcASDFBase):
    """
    Attenuation Adjoint Source ASDF
    """
